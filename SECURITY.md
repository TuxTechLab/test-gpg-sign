...
Contact: [security@tuxtechlab.com](mailto:security@security@tuxtechlab.com)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At TuxTechIaaC, we consider the security of our systems a top priority. But no
...
- E-mail your findings to [security@tuxtechlab.com](mailto:security@tuxtechlab.com).
